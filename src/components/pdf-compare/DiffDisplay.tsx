...
export function DiffDisplay({
  ...
  const changesCount = differences.filter((d) => (side === "left" ? d.removed : d.added)).length;
      ...
      <CardHeader className="border-b border-slate-700 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-slate-400 text-sm">{totalLines} lines</div>
          </div>
                ...
                .map((line, lineIndex) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex ${
                        isModified ? (side === "left" ? "bg-red-600/20" : "bg-emerald-600/20") : ""
